  ...
  return (
    ...
    <section id="testimonials" className="block md:hidden bg-white px-5 py-14 text-center">
      ...
      <div className="bg-[#F3F4F6] rounded-3xl p-6 text-left">
        ...
        <p className="text-sm text-black leading-relaxed mt-2">Working with MeeramTech was a game changer for our organization. Their technical excellence, structured delivery approach, and commitment to quality exceeded our expectations. The level of expertise and reliability they bring to digital infrastructure projects is truly impressive.</p>
    ...
    >
      ...
      <p className={`absolute text-black font-normal text-center ${styles.quoteText}`}>
        Working with MeeramTech was a game changer for our organization. Their
